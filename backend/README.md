...
- **LAN access:** `python app.py` listens on `0.0.0.0:5000` by default. Other computers use `http://<HOST-LAN-IP>:5000` (not Vite `:5173`). Set `FLASK_RUN_HOST=127.0.0.1` for localhost-only.
